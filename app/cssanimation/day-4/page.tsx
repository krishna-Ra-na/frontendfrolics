    ...
    return (
        <>
            <div className="flex flex-col  justify-center min-h-[600px] mt-8">
                <div className="flex justify-center -mt-8 relative bg-[#29292961] rounded-lg border-gray-400 border border-opacity-20 ">
                    {/* solar system */}
                    ...
                    <div class="solar-system">
                        ...
                        <svg class="orbit" width="800" height="800">
                            ...
                            {/* <!-- Venus Orbit --> */}
                            <path id="venus-orbit" d="M 400,150 A 250,125 0 1,1 399.9,150 Z" fill="none" stroke="rgba(255, 255, 255, 0.2)" />
                            <circle class="planet venus" r="14">
                            ...
                            {/* <!-- Earth Orbit --> */}
                            <path id="earth-orbit" d="M 400,100 A 300,150 0 1,1 399.9,100 Z" fill="none" stroke="rgba(255, 255, 255, 0.2)" />
                            <circle class="planet earth" r="16">
                            ...
                            {/* <!-- Mars Orbit --> */}
                            <path id="mars-orbit" d="M 400,50 A 350,175 0 1,1 399.9,50 Z" fill="none" stroke="rgba(255, 255, 255, 0.2)" />
                            <circle class="planet mars" r="12">
